  ...
  container.innerHTML = `
    <div class="product-gallery">
      ...
      <div class="product-thumb-list">
        ...
        <!-- Nếu có nhiều ảnh, render thêm ở đây -->
      </div>
      ...
      <div style="border-top:1px solid #ddd; border-bottom:1px solid #ddd; padding:15px 0; margin:15px 0;">
        <div style="display:flex; align-items:center; margin-bottom:10px;">
          ...
          <p style="margin:0;">Bảo hành 1 đổi 1 trong vòng 12 tháng bởi Nhà Phân Phối (Áp dụng máy bán từ 1.7.2022). Các máy mua trước đó áp dụng bảo hành 12 tháng tại các trung tâm Bảo hành FPT Service trên toàn quốc <strong>Xem chi tiết</strong></p>
        </div>
        
        <div style="display:flex; align-items:center;">
          <span style="color:#d70018; font-size:1.2em; margin-right:8px;">💷</span>
          <p style="margin:0;">Giá sản phẩm <strong>đã bao gồm thuế VAT</strong>, giúp bạn yên tâm và dễ dàng trong việc tính toán chi phí.</p>
        </div>
      </div>
    </div>
    </div>
    <div class="product-info-block">
      ...
      <table class="product-spec-table">
        <tr>
          <th>Mã sản phẩm</th><td>${product.product_id || product.id || "SP" + Math.floor(Math.random()*10000)}</td>
        </tr>
        <tr>
          <th>CPU</th><td>${product.cpu || randomSpecValue('cpu')}</td>
        </tr>
        <tr>
          <th>RAM</th><td>${product.ram || randomSpecValue('ram')}</td>
        </tr>
        <tr>
          <th>Ổ cứng</th><td>${product.ssd || randomSpecValue('ssd')}</td>
        </tr>
        <tr>
          <th>VGA</th><td>${product.vga || randomSpecValue('vga')}</td>
        </tr>
        <tr>
          <th>Màn hình</th><td>${product.display || randomSpecValue('display')}</td>
        </tr>
      </table>
    </div>
  `;
